package hr.springframework.recipeapp.bootstrap;

import hr.springframework.recipeapp.domain.*;
import hr.springframework.recipeapp.repositories.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.debug("Lodaded bootstrap data.");
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.setSource("Simply Rrecipes");
